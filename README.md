...
This project is a fork of the original open-source project [https://github.com/kudelskisecurity/crystals-go](https://github.com/kudelskisecurity/crystals-go), conducted in compliance with open-source licensing rules. It incorporates subsequent modifications and expansions while focusing exclusively on the **post-quantum algorithms CRYSTALS-Dilithium** source code from the original repository.

The project retains the original [CC0 1.0 Universal (CC0 1.0) Public Domain Dedication](https://creativecommons.org/publicdomain/zero/1.0/) license and includes portions of the original `README.md` to maintain consistency with the source material.
